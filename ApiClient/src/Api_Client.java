...
//    protected String api_url = "https://api.bithumb.com/info/ticker";
    protected String api_key;
    protected String api_secret;

    public Api_Client(String api_key, String api_secret) {
	//this.api_key = "fd5e2f77c05ab7526f015c0bd9d60bfa";
	//this.api_secret = "d16682096bafb9279ec1abeaab64408d";
	this.api_key = "73a4a223400fe7a5ba1538737a3302a2";
	this.api_secret = "3cd608683fe4987a82660e5cfcebf2fc";
